...
/// @remarks
//-----------------------------------------------------------------------------
#ifndef __SORT_ALGORITHM_SAMPLE_SORT_HPP
#define __SORT_ALGORITHM_SAMPLE_SORT_HPP
...
using su::uninit_merge_level4 ;
using su::merge_vector4 ;
//
///---------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
sample_sort_tag ( range_it R , compare cmp, const NThread & NT)
                 :owner(false),comp( cmp),
                  global_range(R), global_buf ( nullptr, nullptr)
{   //-------------------------- begin -------------------------------------
...
//-----------------------------------------------------------------------------
sample_sort_tag ( range_it R, compare cmp, const NThread &NT,range_buf RB)
                 :comp( cmp),global_range(R), global_buf ( RB)
{   //-------------------------- begin -------------------------------------
	assert ( R.valid());
    size_t NElem = R.size();
    construct= false ;
