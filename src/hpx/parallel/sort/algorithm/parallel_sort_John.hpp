...
{   //------------------------- begin ----------------------
    ...
    /// @remarks
    //------------------------------------------------------------------------
    parallel_sort_comp ( iter_t first, iter_t last, compare comp1): comp(comp1)
    {   //------------------------- begin ----------------------
        ...
        //-------------------------------------------------------------------
        hpx::future<void> dummy =
        		hpx::async(&parallel_sort_comp::sort_thread,
    ...
    hpx::future<void> sort_thread( iter_t first, iter_t last, uint32_t level)
    {
        ...
        hpx::future<void> hk1 =
        		hpx::async(&parallel_sort_comp::sort_thread,
        				   this, first, c_last, level-1);
        hpx::future<void> hk2 =
        		hpx::async(	&parallel_sort_comp::sort_thread,
        					this, c_first, last, level-1);
        return dataflow(
