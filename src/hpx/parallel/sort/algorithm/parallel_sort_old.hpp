...
/// @remarks
//-----------------------------------------------------------------------------
#ifndef __SORT_ALGORITHM_PARALLEL_SORT_HPP
#define __SORT_ALGORITHM_PARALLEL_SORT_HPP

#include <tools/atomic.hpp>
#include <tools/nthread.hpp>
#include <tools/stack_cnc.hpp>
#include <sort/algorithm/intro_sort.hpp>
#include <sort/algorithm/indirect.hpp>
#include <vector>
