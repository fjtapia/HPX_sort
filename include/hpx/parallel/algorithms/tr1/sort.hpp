...
#include <hpx/parallel/algorithms/tr1/detail/parallel_stable_sort.hpp>
...
//****************************************************************************
using hpx::parallel::tr1::detail::util::compare_iter ;
...
{	//----------------------------- begin -------------------------------
    uint32_t nthread = (uint32_t) hpx::get_os_thread_count() ;
	detail::block_indirect_sort ( first, last,comp, nthread);
};
