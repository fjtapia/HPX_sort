...
/// @remarks
//-----------------------------------------------------------------------------
#ifndef __HPX_PARALLEL_SORT_DETAIL_UTIL_RANGE_HPP
#define __HPX_PARALLEL_SORT_DETAIL_UTIL_RANGE_HPP
...
#include <vector>
#include <cassert>
#include <hpx/parallel/algorithms/tr1/detail/util/low_level.hpp>
