...
/// @remarks
//-----------------------------------------------------------------------------
#ifndef __HPX_PARALLEL_SORT_DETAIL_UTIL_MERGE_VECTOR_HPP
#define __HPX_PARALLEL_SORT_DETAIL_UTIL_MERGE_VECTOR_HPP
...
/// @brief merge the ranges in the vector v_input using full_merge4. The v_output
...
/// @brief merge the ranges over uninitialized memory,in the vector v_input using
...
/// @brief merge the ranges in the vector v_input using merge_level4. The v_output
///        vector is used as auxiliary memory in the internal process
