...
/// @remarks
//-----------------------------------------------------------------------------
#ifndef __HPX_PARALLEL_SORT_DETAIL_PARALLEL_STABLE_SORT_HPP
#define __HPX_PARALLEL_SORT_DETAIL_PARALLEL_STABLE_SORT_HPP
...
#include <vector>
#include <future>
#include <hpx/parallel/algorithms/tr1/detail/sample_sort.hpp>
