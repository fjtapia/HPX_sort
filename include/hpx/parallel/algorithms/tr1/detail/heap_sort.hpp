...
/// @remarks
//-----------------------------------------------------------------------------
#ifndef __HPX_PARALLEL_SORT_DETAIL_HEAP_SORT_HPP
#define __HPX_PARALLEL_SORT_DETAIL_HEAP_SORT_HPP
...
/// @param [in] val_0 : first value to compare
/// @param [in] val_1 : second value to compare
/// @param [in] val_2 : third value to compare
...
/// @remarks
//-----------------------------------------------------------------------------
inline bool sort3 (value_t &val_0  ,value_t &val_1 ,value_t &val_2,
                   bool    &bool_0 ,bool    &bool_1, bool   &bool_2  )
{   //----------------------------- begin-------------------------------
    ...
    {   case 0: break ;
        ...
        case 2: std::swap ( val_1 , val_2);
                bool_1 = bool_2 = true ;
                break ;

        case 3: if ( not ( val_0 >  val_1))
        ...
        case 4: std::swap ( val_0 , val_1);
                bool_0 = bool_1 = true ;
                break ;

        case 5: if ( val_1 > val_2)
...
/// @param [in] nelem : number of lements of the range
...
/// @remarks This algorithm is O(NLogN)
//-----------------------------------------------------------------------------
heap_sort ( Iter_t first , Iter_t last , Compare comp = Compare() )
{   //--------------------------- begin -----------------------------
    assert ( (last - first) >= 0 );
    ...
    {   std::swap ( *first , * (first + (nelem-i)));
        ...
        {   // if the father have two sons must select the bigger
            ...
            if ((pos_son + 1) < (nelem-i) and comp(*iter_son,*(iter_son +1)))
            {   ++pos_son ;
                ++iter_son ;
            };
            if ( (sw = comp(*iter_father, *iter_son)) )
